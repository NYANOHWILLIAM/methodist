...
// Query to get the total number of records where age is between 6 and 10 years for the specified church
$sql = "SELECT COUNT(*) AS total_count FROM registration WHERE DATEDIFF(CURDATE(), dob) / 365 BETWEEN 6 AND 10 AND church = ?";
...
if ($result !== false && $result->num_rows > 0) {
    ...
    echo "CHILDREN AGED 6-10 YEARS at $churchFromURL<br>";
    echo "Total number of children aged 6-10 years: " . $totalCount . "<br>";
} else {
    echo "No data found for children aged 6-10 years at $churchFromURL.";
}
