...
$otherUrl = "formal.php?church=$encodedChurch&loginName=$encodedLoginName";
?>

<!-- Output the link to the other URL (allmembers.php) -->
<a class='form-link' href="<?php echo $otherUrl; ?>">FORMAL</a>
<br>
...
// Create a link to the allmembers.php page with the encoded church and loginName
$otherUrl = "selfemployed.php?church=$encodedChurch&loginName=$encodedLoginName";
?>

<!-- Output the link to the other URL (allmembers.php) -->
<a class='form-link' href="<?php echo $otherUrl; ?>">SELF EMPLOYED</a>
<br>
...
// Create a link to the allmembers.php page with the encoded church and loginName
$otherUrl = "unemployed.php?church=$encodedChurch&loginName=$encodedLoginName";
?>

<!-- Output the link to the other URL (allmembers.php) -->
<a class='form-link' href="<?php echo $otherUrl; ?>">UNEMPLOYMENTS</a>
<br>
...
// Create a link to the allmembers.php page with the encoded church and loginName
$otherUrl = "retired.php?church=$encodedChurch&loginName=$encodedLoginName";
?>

<!-- Output the link to the other URL (allmembers.php) -->
<a class='form-link' href="<?php echo $otherUrl; ?>">RETIRED</a>
<br>
...
// Create a link to the allmembers.php page with the encoded church and loginName
$otherUrl = "student.php?church=$encodedChurch&loginName=$encodedLoginName";
?>

<!-- Output the link to the other URL (allmembers.php) -->
<a class='form-link' href="<?php echo $otherUrl; ?>">STUDENTS</a>
<br>
