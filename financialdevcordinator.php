...
<?php include 'pages/church.php'; ?>
 ...
 <h3>FINANCIAL DEVELOPMENT CORDINATORS</h3>
<style>
...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        $membershipStatus = "Finance_Dev_Coordinator"; // Change to the desired membership status

        // Query to retrieve data for Finance Development Coordinators in the specified church
    ...
    <script>
        function printTable(church) {
            var tableHeader = '<h1>THE METHODIST CHURCH - GHANA</h1>' +
                '<h2>' + church + '</h2>' +
                '<h1>FINANCIAL DEVELOPMENT CORDINATORS</h1>';
