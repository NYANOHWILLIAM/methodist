...
<li class="nav-item">
    <a href="vieww.php?id=<?php echo urlencode($id); ?>&loginName=<?php echo urlencode($loginName)?>&church=<?php echo urlencode($church); ?>">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO expenditure (itemname, amount, message, loginname, church, quantity) VALUES (?, ?, ?, ?, ?, ?)";
