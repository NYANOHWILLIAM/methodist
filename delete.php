...
$date = $_GET['date'];
$query = "DELETE FROM mdf WHERE date = ?";
...
?>
    <script type="text/javascript">
        ...
        window.open("http://localhost/new/view.php?loginName=<?php echo $loginName ?>&id=<?php echo $id ?>&church=<?php echo $church ?>&contact=<?php echo $contact ?>", "_self");
    </script>
<?php
} else {
?>
