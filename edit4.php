...
if (isset($_GET['date'])) {
    ...
    $select = "SELECT * FROM welfare WHERE date='$date'";
...
if (isset($_POST['update_btn'])) {
    ...
    $update = "UPDATE welfare SET amount='$amount' WHERE date='$date'";
...
<h2>WELFARE CONTRIBUTION UPDATE</h2>
<h3><b>EDIT</b></h3>
...
echo "<button style='margin-right: 30px;'><a href='newa.php?loginName=" . urlencode($loginName) . "'>NEW ENTRY</a></button>";
echo "<button style='margin-right: 30px;'><a href='view4.php?loginName=" . urlencode($loginName) . "'>DELETE/PRINT</a></button>";
