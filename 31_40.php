...
// Query to get the total number of records where age is between 31 and 40 years for the specified church
$sql = "SELECT COUNT(*) AS total_count FROM registration WHERE DATEDIFF(CURDATE(), dob) / 365 BETWEEN 31 AND 40 AND church = ?";
...
if ($result !== false && $result->num_rows > 0) {
    ...
    echo "ADULTS AGED 31-40 YEARS at $churchFromURL<br>";
    echo "Total number of adults aged 31-40 years: " . $totalCount . "<br>";
} else {
    echo "No data found for adults aged 31-40 years at $churchFromURL.";
}
