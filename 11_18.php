...
// Query to get the total number of records where age is between 11 and 18 years for the specified church
$sql = "SELECT COUNT(*) AS total_count FROM registration WHERE DATEDIFF(CURDATE(), dob) / 365 BETWEEN 11 AND 18 AND church = ?";
...
if ($result !== false && $result->num_rows > 0) {
    ...
    echo "YOUTH AGED 11-18 YEARS at $churchFromURL<br>";
    echo "Total number of youth aged 11-18 years: " . $totalCount . "<br>";
} else {
    echo "No data found for youth aged 11-18 years at $churchFromURL.";
}
