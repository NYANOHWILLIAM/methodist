...
// Query to get the total number of records where age is between 26 and 30 years for the specified church
$sql = "SELECT COUNT(*) AS total_count FROM registration WHERE DATEDIFF(CURDATE(), dob) / 365 BETWEEN 26 AND 30 AND church = ?";
...
if ($result !== false && $result->num_rows > 0) {
    ...
    echo "ADULTS AGED 26-30 YEARS at $churchFromURL<br>";
    echo "Total number of adults aged 26-30 years: " . $totalCount . "<br>";
} else {
    echo "No data found for adults aged 26-30 years at $churchFromURL.";
}
