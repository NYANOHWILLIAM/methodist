...
// Query to get the total number of records where age is between 0 and 5 years for the specified church
$sql = "SELECT COUNT(*) AS total_count FROM registration WHERE DATEDIFF(CURDATE(), dob) / 365 BETWEEN 0 AND 5 AND church = ?";
...
if ($result !== false && $result->num_rows > 0) {
    ...
    echo "CHILDREN AGED 0-5 YEARS at $churchFromURL<br>";
    echo "Total number of children aged 0-5 years: " . $totalCount . "<br>";
} else {
    echo "No data found for children aged 0-5 years at $churchFromURL.";
}
