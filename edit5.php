...
<li class="nav-item">
    <a href="view4.php?id=<?php echo urlencode($id); ?>&loginName=<?php echo urlencode($loginName)?>&church=<?php echo urlencode($church)?>&contact=<?php echo urlencode($contact); ?>">
...
if (isset($_POST['update_btn'])) {
    ...
    if ($result) {
        ...
        header("Location: view4.php?loginName=$loginName&id=$id&church=$church&contact=$contact");
        exit();
    } else {
...
<script>
    function sendData() {
        ...
        var url = "view4.php?date=" + encodeURIComponent(date) + "&church=" + encodeURIComponent(church) + "&loginName=" + encodeURIComponent(loginName) + "&id=" + encodeURIComponent(id)+ "&contact=" + encodeURIComponent(contact);
