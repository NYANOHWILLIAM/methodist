...
// Query to get the total number of records where age is between 19 and 25 years for the specified church
$sql = "SELECT COUNT(*) AS total_count FROM registration WHERE DATEDIFF(CURDATE(), dob) / 365 BETWEEN 19 AND 25 AND church = ?";
...
if ($result !== false && $result->num_rows > 0) {
    ...
    echo "YOUNG ADULTS AGED 19-25 YEARS at $churchFromURL<br>";
    echo "Total number of young adults aged 19-25 years: " . $totalCount . "<br>";
} else {
    echo "No data found for young adults aged 19-25 years at $churchFromURL.";
}
