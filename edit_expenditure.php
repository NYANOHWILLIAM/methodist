...
<li class="nav-item">
    <a href="vieww.php?id=<?php echo urlencode($id); ?>&loginName=<?php echo urlencode($loginName)?>&church=<?php echo urlencode($church)?>&contact=<?php echo urlencode($contact); ?>">
...
if (isset($_POST['update_btn'])) {
    ...
    $update = "UPDATE expenditure SET itemname ='$itemname', quantity='$quantity', amount='$amount', message='$message' WHERE id='$id'";
    ...
    if ($result) {
        ...
        echo '<script type="text/javascript">
            ...
            window.location.href = "vieww.php?loginName=' . $loginName . '&id=' . $id . '&church=' . $church .'";
        </script>';
        exit();
    } else {
