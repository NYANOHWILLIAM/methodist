...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        $membershipStatus = "EMR_Coordinator"; // Change to the desired membership status

        // Query to retrieve data for EMR Coordinators in the specified church
