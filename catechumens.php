...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        $membershipStatus = "catechumens"; // Change to the desired membership status

        // Query to retrieve data for catechumens in the specified church
        $query = "SELECT firstname, middlename, lastname FROM registration WHERE membership = '$membershipStatus' AND church = '$churchParam'";
