...
<?php include 'pages/church.php'; ?>
 ...
 <h3>EDUCATION YOUTH CORDINATORS</h3>
<style>
...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        $membershipStatus = "Education_Youth_Coordinator"; // Change to the desired membership status

        // Query to retrieve data for Education and Youth Coordinators in the specified church
    ...
    <script>
        function printTable(church) {
            var tableHeader = '<h1>THE METHODIST CHURCH - GHANA</h1>' +
                '<h2>' + church + '</h2>' +
                '<h1>EDUCATION YOUTH CORDINATORS</h1>';
