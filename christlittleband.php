...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        // Define the organ to search for
        $organ = "Christ_Little_Band"; // Change to the desired organ

        // Query to retrieve data for individuals with "Christ_Little_Band" in the comma-separated "Organ" column
        $query = "SELECT firstname, middlename, lastname FROM registration WHERE FIND_IN_SET('$organ', organ) AND church = '$churchParam'";
