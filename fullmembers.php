...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        // Query to retrieve data for full members in the specified church
        $query = "SELECT firstname, middlename, lastname FROM registration WHERE membership = 'full_member' AND church = '$churchParam'";
