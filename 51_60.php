...
// Query to get the total number of records where age is between 51 and 60 years for the specified church
$sql = "SELECT COUNT(*) AS total_count FROM registration WHERE DATEDIFF(CURDATE(), dob) / 365 BETWEEN 51 AND 60 AND church = ?";
...
if ($result !== false && $result->num_rows > 0) {
    ...
    echo "ADULTS AGED 51-60 YEARS at $churchFromURL<br>";
    echo "Total number of adults aged 51-60 years: " . $totalCount . "<br>";
} else {
    echo "No data found for adults aged 51-60 years at $churchFromURL.";
}
