...
<?php include 'pages/church.php'; ?>
 ...
 <h3>CHILDREN SERVICE TEACHERS</h3>
<style>
...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        $membershipStatus = "Children_Service_Teacher"; // Change to the desired membership status

        // Query to retrieve data for Children Service Teachers in the specified church
    ...
    <script>
        function printTable(church) {
            var tableHeader = '<h1>THE METHODIST CHURCH - GHANA</h1>' +
                '<h2>' + church + '</h2>' +
                '<h1>CHILDREN SERVICE TEACHERS</h1>';
