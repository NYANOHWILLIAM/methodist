...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        $organ = "Boys_Girls_Brigade"; // Change to the desired organ

        // Query to retrieve data for individuals with "Boys_Girls_Brigade" in the comma-separated "Organ" column
