...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        $organ = "Girls_Fellowship"; // Change to the desired organ

        // Query to retrieve data for individuals with "Girls_Fellowship" in the comma-separated "Organ" column
