...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        // Define the marital status to search for
        $maritalStatus = "Customary"; // Change to the desired marital status

        // Query to retrieve data for individuals with the specified marital status in the specified church
        $query = "SELECT firstname, middlename, lastname FROM registration WHERE marital = '$maritalStatus' AND church = '$churchParam'";
