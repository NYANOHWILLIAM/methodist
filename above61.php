...
// Query to get the total number of records where age is 61 years or older for the specified church
$sql = "SELECT COUNT(*) AS total_count FROM registration WHERE DATEDIFF(CURDATE(), dob) / 365 >= 61 AND church = ?";
...
if ($result !== false && $result->num_rows > 0) {
    ...
    echo "SENIOR ADULTS AGED 61 YEARS OR OLDER at $churchFromURL<br>";
    echo "Total number of senior adults aged 61 years or older: " . $totalCount . "<br>";
} else {
    echo "No data found for senior adults aged 61 years or older at $churchFromURL.";
}
