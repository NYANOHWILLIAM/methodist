...
<li class="nav-item">
    <a href="view.php?id=<?php echo urlencode($id); ?>&loginName=<?php echo urlencode($loginName); ?>">
...
if (isset($_POST['update_btn'])) {
    ...
    $update = "UPDATE attend SET year='$year', cells='$cells', number='$number', number1='$number1' WHERE id='$id'";
...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <input type="number" id="year" name="year" placeholder="YYYY" value="<?php echo htmlspecialchars(isset($row['year']) ? $row['year'] : ''); ?>"><br>

    <label for="cells">ENTER CELL:</label>
    <input type="text" id="cells" name="cells" placeholder="" value="<?php echo htmlspecialchars(isset($row['cells']) ? $row['cells'] : ''); ?>"><br>

    <label for="number">MALE:</label>
    <input type="number" name="number" id="number" placeholder="Enter the number here" value="<?php echo htmlspecialchars(isset($row['number']) ? $row['number'] : ''); ?>"><br>

    <label for="number1">FEMALE:</label>
    <input type="number" name="number1" id="number1" placeholder="Enter the number here" value="<?php echo htmlspecialchars(isset($row['number1']) ? $row['number1'] : ''); ?>"><br>
