...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        $membershipStatus = "Assistant_Class_Leader"; // Change to the desired membership status

        // Query to retrieve data for Assistant Class Leaders in the specified church
