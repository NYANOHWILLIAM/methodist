...
<?php
    ...
    if (isset($_GET['church'])) {
        ...
        // Define the employment status to search for
        $employmentStatus = "Formal"; // Change to the desired employment status

        // Query to retrieve data for individuals with the specified employment status in the specified church
        $query = "SELECT firstname, middlename, lastname FROM registration WHERE employment = '$employmentStatus' AND church = '$churchParam'";
