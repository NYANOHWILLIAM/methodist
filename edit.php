...
<li class="nav-item">
    <a href="view.php?id=<?php echo urlencode($id); ?>&loginName=<?php echo urlencode($loginName)?>&church=<?php echo urlencode($church)?>&contact=<?php echo urlencode($contact); ?>">
...
if (isset($_GET['date']) && isset($_GET['church'])) {
    ...
    $select = "SELECT * FROM mdf WHERE date='$date' AND church='$church'";
...
if (isset($_POST['update_btn'])) {
    ...
    $update = "UPDATE mdf SET amount='$amount' WHERE date='$date' AND church='$church'";
    ...
    if ($result) {
        ...
        header("Location: view.php?loginName=$loginName&id=$id&church=$church&contact=$contact");
        exit();
    } else {
...
<script>
    function sendData() {
        ...
        var url = "view.php?date=" + encodeURIComponent(date) + "&church=" + encodeURIComponent(church) + "&loginName=" + encodeURIComponent(loginName) + "&id=" + encodeURIComponent(id)+ "&contact=" + encodeURIComponent(contact);
